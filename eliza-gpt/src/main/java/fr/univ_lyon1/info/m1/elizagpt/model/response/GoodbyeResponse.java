 ...
 */
public class GoodbyeResponse implements Response {
    ...
    final List<Verb> listVerb) {
        ...
        if (matcher.matches()) {
            ...
            String[] array = {"Oh non, c'est trop triste de se quitter !", (user.getName() != null) 
            ? "Au revoir " + user.getName() + " ." : "Au revoir ."};
            // Generate a random index within the range of the array length
            int randomIndex = random.nextInt(array.length);
            final String quest = array[randomIndex];
            return new Message(TextProcess.normalize(quest), false);
        }
